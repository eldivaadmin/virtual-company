...
function spritePath(a,kind,dir='down',frame=1){
  if(kind==='work') return `/assets/characters/${a.sprite}/work.png`;
  if(kind==='idle') return `/assets/characters/${a.sprite}/idle.png`;
  return `/assets/characters/${a.sprite}/walk_${dir}_${frame}.png`;
}
...
function renderAgent(a){
  states[a.id]={x:a.seat[0],y:a.seat[1],state:'present'};
